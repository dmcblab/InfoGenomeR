		...
		cout<<"segend"<<endl;
               ...
               if(i%2){
                        ...
                        if(full_edges_list_rsv.size()!=0){
                                for(list<full_edges>::iterator rsv_it = full_edges_list_rsv.begin(); rsv_it != full_edges_list_rsv.end(); rsv_it ++){
                                        list<full_edges> full_edges_list_rsv_t;
                                        full_edges_list_rsv_t.push_back(*rsv_it);
                                        g1.addEdges(full_edges_list_rsv_t);
                                }
                        }
                }else{
                       if(full_edges_list_rsv.size()!=0){
